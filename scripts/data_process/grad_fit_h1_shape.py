...
# sys.path.append("/home/kasm-user/expressive_humanoid/ASE/ase/poselib")
...
joblib.dump((shape_new.detach().cpu(), scale.detach().cpu()), "data/h1/shape_optimized_v1.pkl") # V2 has hip jointsrea
