...
from phc.utils.torch_stompy_humanoid_batch import (
    Stompy_Batch,
    STOMPY_ROTATION_AXIS,
)
...
pose_aa_stompy = torch.cat(
    [
        torch.zeros((1, 1, 3)),
        STOMPY_ROTATION_AXIS * dof_pos[..., None],
        torch.zeros((1, 2, 3)),
    ],
    axis=1,
)
...
fk_return = stompy_fk.fk_batch(
    pose_aa_stompy[None,], root_trans_offset[None, 0:1]
)
...
for iteration in range(1000):
    ...
    diff = (
        fk_return.global_translation_extend[:, :, stompy_joint_pick_idx]
...
joblib.dump(
    ...
    "data/stompy/shape_optimized_v1.pkl",
